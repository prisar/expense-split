...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb://localhost:27017/expensedb',
    ...
    DEFAULT_MASTER_DATA_NAME: process.env.DEFAULT_MASTER_DATA_NAME || 'Master data',
    ...
    EMAIL: {
      ...
      host: process.env.SMTP_HOST || (process.env.SENDGRID_USERNAME ? 'smtp.sendgrid.net' : 'smtp.mailtrap.io'),
      port: process.env.SMTP_PORT || (process.env.SENDGRID_USERNAME ? 587 : 2525),
      auth: {
        user: process.env.SMTP_USER || process.env.SENDGRID_USERNAME || '566726f282b72b686',
        pass: process.env.SMTP_PASSWORD || process.env.SENDGRID_PASSWORD || 'cc21d22911ed88'
      }
    }
  }
